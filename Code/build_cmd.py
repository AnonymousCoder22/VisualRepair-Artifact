...
def normalized_repo_path(instance_repo_path):
    return (instance_repo_path or "").lower()


def has_node_modules(instance_repo_path):
...
def make_check_cmd(instance_repo_path):
    repo_path_lower = normalized_repo_path(instance_repo_path)
    if "highlightjs" in repo_path_lower:
        if has_node_modules(instance_repo_path):
            return "node ./tools/build.js -t browser"
        return "npm install && node ./tools/build.js -t browser"
    ...
    if "bpmn-js" in instance_repo_path:
        ...
        build_cmd = "yarn run lint"
    elif "prismjs" in repo_path_lower:
        build_cmd = "ls"
...
def make_build_cmd(instance_repo_path):
    ...
    elif "chartjs" in repo_path_lower:
        build_cmd = "pnpm install && pnpm build"

    elif "markedjs" in repo_path_lower:
